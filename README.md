...
### Work Experience
- 와이지지알(YGGR) AX(AI Transformation) 개발자 (2026.07 ~ )

---
### Education
- 광운대학교 미디어커뮤니케이션학부/정보융합학부(데이터사이언스 전공) 졸업 (2025)
- 광운대학교 IDEA Lab. 학부연구생 / AI 도슨트 앱 Artvoice 백엔드 개발 참여 (2025)
- SeSAC iOS 앱개발자 데뷔과정 PLUS 영등포 7기 (2025)
- 구름톤 트레이닝 정보 보호 전문가 양성 마스터 클래스 과정 (2024)
